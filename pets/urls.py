...
urlpatterns = patterns('',
    ...
    url(r'^mascotaVacuna/$','principal.views.mascotaVacuna'),
    url(r'^vacunas/(?P<idMascota>[-\w]+)/$','principal.views.vacunas'),
    ...
    url(r'^perfilMedico/$','principal.views.perfilMedico'),
    url(r'^medicos/$','principal.views.medicos'),
    url(r'^peluqueria/$','principal.views.peluqueria'),
    url(r'^fechaPeluqueria/(?P<idMascota>[-\w]+)/$','principal.views.fechaPeluqueria'),
    url(r'^principalMedico/$','principal.views.principalMedico'),
